...
import 'package:food_ui_2/constants/radius.dart';
import 'package:food_ui_2/constants/shadow.dart';
...
import 'package:food_ui_2/models/restaurant_model.dart';
import 'package:food_ui_2/presentation/widgets/indicator.dart';
import 'package:food_ui_2/presentation/widgets/material.dart';
    ...
    return Obx(() {
      List<CategoryModel> displayedCategories =
          controller.showAllCategories.value
              ...
              : controller.categories.sublist(0, 5);
      double containerHeight = displayedCategories.length * 30.0;
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        tr(controller.showAllCategories.value
                            ? "View Less"
                            : "View All"),
                        style: TextStyle(
                          color: AppColors.orange100,
          ...
          AnimatedContainer(
            ...
            child: Wrap(
              ...
              children: List.generate(displayedCategories.length, (index) {
                final CategoryModel item = displayedCategories[index];
